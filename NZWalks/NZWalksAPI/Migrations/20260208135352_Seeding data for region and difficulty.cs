    ...
    public partial class Seedingdataforregionanddifficulty : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("601957a0-1a55-4a41-aa16-fb8ecdcead33"), "Hard" },
                    { new Guid("6fce9d4a-5e67-4abf-abb5-70b2cbbd6018"), "Medium" },
                    { new Guid("a6523edf-81e1-4020-ae9a-af0fe579ba58"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("601957a0-1a55-4a41-aa16-fb8ecdcead33"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("6fce9d4a-5e67-4abf-abb5-70b2cbbd6018"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a6523edf-81e1-4020-ae9a-af0fe579ba58"));
